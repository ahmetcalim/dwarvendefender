    ...
    public class LimbHackerAgent : MonoBehaviour
    {
        ...
        void ConsumeJobYield(JobState jobState)
        {
            ...
            else
            {
                ...
                var parent = originalSubjectTransform.transform.parent;
                
                var position = originalSubjectTransform.GetComponentInChildren<Animator>().transform.position;
                var scale = originalSubjectTransform.GetComponentInChildren<Animator>().transform.localScale;

                var rotation = originalSubjectTransform.GetComponentInChildren<Animator>().transform.rotation;

                alfaObject.transform.parent = parent;
                alfaObject.transform.position = position;
                alfaObject.transform.localScale = scale;

                alfaObject.transform.rotation = rotation;
                ...
                if (backIsNew)
                {
                    ...
                    bravoObject.transform.position = position;
                    bravoObject.transform.localScale = scale;

                    bravoObject.transform.rotation = rotation;
        ...
        static void ApplySnapshotsToRoot(GameObject root, IEnumerable<MeshSnapshot> snapshots)
        {
            ...
            if (!root.GetComponent<ActiveChecker>())
            {
                root.AddComponent<ActiveChecker>();
            }
